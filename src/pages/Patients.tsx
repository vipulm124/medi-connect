...
function Patients() {
  ...
  return (
    <section id="patients" className="page-section min-h-screen bg-white p-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          ...
          <div className="mt-4 md:mt-0 flex flex-col sm:flex-row gap-3">
            <button
              ...
              id="newPatientBtn" onClick={handleOpenModal}
            >
              <Plus className="mr-2" />
              Add New Patient
            </button>
            <div className="relative">
              <input
                ...
                className="px-4 py-2 w-full sm:w-64 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
      ...
      {showNewPatientModal && <NewPatientModal isVisible={showNewPatientModal} onClose={handleCloseModal} />}
    </section>
  );
}
